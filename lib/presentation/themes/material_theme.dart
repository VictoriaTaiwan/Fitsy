...
class AppColors {
  ...
  static const Color rose = Color(0xFF8C6E5D);
...
class MaterialTheme {
  ...
  static ColorScheme darkColorScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFCE8537), // active button
      onPrimary: AppColors.dark, // text on primary (base)
      ...
      surface: AppColors.lightMuted, // main background
      onSurface: AppColors.light,

      // Variants
      surfaceTint: AppColors.dark,
      onSurfaceVariant: AppColors.dark, // inactive button color //
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
    ...
    backgroundColor: colorScheme.primaryContainer, // force button bg color
    foregroundColor: colorScheme.onPrimaryContainer,
    )),
    cardTheme: CardTheme(
      color: AppColors.lightYellow, // card background
      surfaceTintColor: colorScheme.primaryContainer, // for Material 3 elevation tint
